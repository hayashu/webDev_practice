...
app.get("/", (req, res) => {
  //TODO Step 1 - Make the get route work and render the index.ejs file.
  res.render("index.ejs");
});

app.post("/submit", (req, res) => {
  //TODO Step 2 - Make the generate name functionality work
  ...
  const randomNumNoun = Math.floor(Math.random() * adj.length);

  let y = d.getFullYear();
  res.render("index.ejs",{
    flag : true,
    year : y,
    words : adj[randomNumAdj]+" "+randomNumNoun[randomNumNoun],
  })
});
